...
$sql = mysql_query("SELECT age,sex,chol from patient_details  LIMIT ".$limits.",".$max."") or die    (mysql_error());
echo "<div align='right'><a href='svm_classification_option.php'><img width=100 height=40 src='images/home2.png'></div></a></div>";

echo "<center><h1 style='color:white; font-size:30px'>"."SERUM-CHOLESTROL-LEVEL DATA CLASSIFICATION  "."</h1>";
...
echo "<th style='background-color:black;color:white;height:30px;'>"."SERUM-CHOLESTROL-LEVEL"."</th>";
