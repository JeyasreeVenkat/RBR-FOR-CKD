...
$j=1;
$sql = mysql_query("SELECT method,pre_value,recall_value,f_value from ckd_f1_measure LIMIT ".$limits.",".$max." ") or die    (mysql_error());
...
echo "<tr><td height=30 align='center' style='color:black;font-size:30px'> <b><u> RBR-SVM-FMEASURE-VIEW </u></b></td></tr>";
